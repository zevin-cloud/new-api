...
func GetStatus(c *gin.Context) {
	...
	data := gin.H{
		...
		"show_registration_enabled":     common.RegisterEnabled && operation_setting.GetUsageSetting().ShowRegistration(),
		"site_label_enabled":            operation_setting.GetUsageSetting().ShowSiteLabel(),
		"site_label_text":               operation_setting.GetUsageSetting().SiteLabelText,
