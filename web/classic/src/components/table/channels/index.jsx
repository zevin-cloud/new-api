...
import ClientQuotaModal from './modals/ClientQuotaModal';
...
const ChannelsPage = () => {
  ...
  return (
    <>
      ...
      />
      {channelsData.showClientQuotaModal && channelsData.clientQuotaChannel && (
        <ClientQuotaModal
          account={channelsData.clientQuotaChannel}
          onClose={channelsData.closeClientQuotaModal}
        />
      )}
